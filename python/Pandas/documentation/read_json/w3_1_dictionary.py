...
# Os objetos JSON têm o mesmo formato
#  dos dicionários Python.

# Se o seu código JSON não estiver em um arquivo,
#  mas em um Dicionário Python, você poderá carregá-lo
